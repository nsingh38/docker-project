...
connection.connect(function (err) {
	...
	var sql = "CREATE DATABASE IF NOT EXISTS `docker_proj` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci; USE `docker_proj`; CREATE TABLE IF NOT EXISTS `accounts` (id int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARSET=utf8";
